...
public interface IServidor extends Remote {
    String iniciar_sesion(ICliente oremoto, String nombre, String contrasena) throws SQLException,ContrasenaErronea, FalloUsuario, RemoteException, MalformedURLException, NotBoundException;
